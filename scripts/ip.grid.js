...
var defaultRowHeight = 20;    //Default row width
var defaultColWidth = 60;    //Default column width
...
(function ($) {
    ...
    $.fn.ip_ResizeColumn = function (options) {
        ...
        var options = $.extend({
            ...
            columns: [-1],        
            size: ip_GridProps['demo'].dimensions.defaultColWidth //int, must be pixels
    ...
    $.fn.ip_ResizeRow = function (options) {
        ...
        var options = $.extend({
            ...
            rows: [-1],
            size: ip_GridProps['demo'].dimensions.defaultRowHeight // int, must be pixels
